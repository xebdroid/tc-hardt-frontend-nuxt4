...
<template>
  <div
    ...
    :class="[containerHeightClass, !slides.length ? fallbackClass : 'bg-gray-900', `theme-${props.theme}`, { 'pt-[70px] lg:pt-[160px]': !removeTopPadding && slides.length < 1 }]"
  >
    ...
    >
      ...
      >
        ...
        <div
          ...
          :class="[getContentClass(slide.contentPosition), { 'pt-[70px] lg:pt-[160px]': !removeTopPadding && slides.length >= 1 }]"
        >
